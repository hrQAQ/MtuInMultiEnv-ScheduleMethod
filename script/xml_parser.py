...
class Flow(object):
    ...
    def __init__(self, flow_el):
        ...
        self.flowCompletionTime = (parse_time_ns (flow_el.get('timeLastRxPacket')) - parse_time_ns(flow_el.get('timeFirstTxPacket')))
        # print(self.flowCompletionTime)
